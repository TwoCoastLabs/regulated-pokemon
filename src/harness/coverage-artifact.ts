...
export interface CoverageArtifact {
  ...
  lessonDoor?: boolean;
  /** Set when the lesson door asked the model what kind of question an ask
   * was, where the matcher offered the boundary alone. */
...
export function buildCoverageArtifact(input: CoverageArtifactInput): CoverageArtifact {
  ...
  return {
    ...
    ...(input.followSuggestion === undefined ? {} : { followSuggestion: input.followSuggestion }),
