...
Findings §36: over the whole answerable set, three repetitions, the
first suggestion taken as the next ask was answered with the lesson or
field promised on 207 of 211 follow-ups (98%) on the strong model and
168 of 196 (86%) on the weak, at 1.02 and 1.07 calls per follow-up. The
small run first (§35) found three harness gaps in 30 entries. "Them" after a count is
